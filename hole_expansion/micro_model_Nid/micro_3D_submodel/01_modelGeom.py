...
boxsize = 30
surfFile = 'recon2D_Drill3_1_30um_16pnts_trim400-900_x250z120_roughness.csv'

boxH_Ratio = 'full'            # 'full' for cubic box or number for box with ratio height
curveCorrect_ratio = 0.95      # height reduction to compensate hole curve of macro model to flat submodel box
...
# meshing parameters
surfMeshSize = 0.8       # unit = um
localMeshSeed = 3        # number of seeds
transMeshSeed = 5        # number of seeds
globalMeshSize = 3       # unit = um
...
# Create box
## Draw wireframe as base on the first plane

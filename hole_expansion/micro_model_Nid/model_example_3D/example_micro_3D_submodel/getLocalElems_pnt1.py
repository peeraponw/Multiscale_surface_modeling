...
path = ''
caeName = 'HET_submodel3D_39' # without .cae
if caeName[-4:] == '.cae': caeName = caeName[:-4]

localPoint = (5000.56, 620, 192.653)
localRadius = 2.5
shiftRatio = 0.8    # 1 = whole sphere in submodel box
...
mdb.close()
with open('localElems_pnt1'+'.csv', 'w') as out:

...
materialName_local1 = 'DP1000_local1'
materialFile_local1 = 'DP1000M_local1.inp'

materialName_local2 = 'DP1000_local2'
materialFile_local2 = 'DP1000M_local2.inp'

materialName_local3 = 'DP1000_local3'
materialFile_local3 = 'DP1000M_local3.inp'
...
# local material 1
myModel.Material(name = materialName_local1)
myMaterial = myModel.materials[materialName_local1]
myMaterial.Elastic(table=((youngMod, poissonRatio), ))
myMaterial.Density(table=((density, ), ))
# local material 2
myModel.Material(name = materialName_local2)
myMaterial = myModel.materials[materialName_local2]
myMaterial.Elastic(table=((youngMod, poissonRatio), ))
myMaterial.Density(table=((density, ), ))
# local material 3
myModel.Material(name = materialName_local3)
myMaterial = myModel.materials[materialName_local3]
myMaterial.Elastic(table=((youngMod, poissonRatio), ))
myMaterial.Density(table=((density, ), ))
...
myModel.HomogeneousSolidSection(material = materialName_local1, name = 'Section-2', thickness = None)
platePart.SectionAssignment(sectionName = 'Section-2', region = platePart.sets['localMat1'])
myModel.HomogeneousSolidSection(material = materialName_local2, name = 'Section-3', thickness = None)
platePart.SectionAssignment(sectionName = 'Section-3', region = platePart.sets['localMat2'])
myModel.HomogeneousSolidSection(material = materialName_local3, name = 'Section-4', thickness = None)
platePart.SectionAssignment(sectionName = 'Section-4', region = platePart.sets['localMat3'])
    ...
    with open(jobName+'.inp', 'w') as outfile:
        ...
        for line in lines:
            if line == '** MATERIALS':
                ...
                outfile.write('* INCLUDE, input='+materialFile_local1+'\n')
                outfile.write('* INCLUDE, input='+materialFile_local2+'\n')
                outfile.write('* INCLUDE, input='+materialFile_local3+'\n')
                counter += 1

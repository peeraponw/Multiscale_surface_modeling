...
myAssembly.translate(instanceList = ['Merged_Part-BOT'], vector = (0., -boxsize, 0.))
...
myAssembly.translate(instanceList = ['Merged_Part-BOTLEFT'], vector = (-boxsize, -boxsize, 0.))
...
myAssembly.translate(instanceList = ['Merged_Part-BOTRIGHT'], vector = (boxsize, -boxsize, 0.))
